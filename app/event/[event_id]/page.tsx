import { getEventDetailedData } from "@/lib/data/data";
	...
	return (
		<main className="flex min-h-screen flex-col items-center justify-between p-5 pt-10 lg:pt-24 lg:p-24">
			<div className="w-full lg:max-w-5xl">
				<section>
					<h1 className="mb-16 text-5xl font-semibold">{event.name}</h1>
				</section>
				<section className="lg:flex mb-8">
					...
					<div className="lg:px-0">
						<h2 className="text-2xl">
							{event_date.getDate() +
								" " +
								event_date.toLocaleString("default", { month: "long" }) +
								" " +
								event_date.getFullYear() +
								", " +
								event_date.toLocaleTimeString("default", {
									hour12: true,
									hour: "numeric",
									minute: "numeric",
								})}
